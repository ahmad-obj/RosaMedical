...
- Iris Scissors: codes `04/05/06-0901` straight and `04/05/06-0911` curved, 10.5 cm, sharp.
- Stevens Scissors: codes `04/05/06-0800`, `0810`, `0802`, and `0812`, covering 9.5 cm and 11.5 cm straight and curved sharp variants.

Earlier discussion accidentally swapped the Iris and Stevens code groups. This specification supersedes that mistake.
