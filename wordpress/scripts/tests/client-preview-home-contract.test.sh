...
for marker in hero who featured feature latest promos why proof evidence; do rg -Fq "data-home-section=\"$marker\"" wordpress/wp-content/themes/rosa-medical-child || fail "missing measured homepage role: $marker"; done
