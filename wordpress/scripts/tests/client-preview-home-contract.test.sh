...
grep -Fq '@media(max-width:63.9375rem)' "$CSS" || fail '1024px Home grid must retain four columns'
grep -Fq '@media (max-height: 800px)' "$CSS" || fail 'short-height desktop safeguard missing'
