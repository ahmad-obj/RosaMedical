...
final class ContactLayoutWidget extends AbstractRosaSectionWidget
{
    ...
    public function get_title(): string { return 'Rosa Contact — Details & Email Form'; }
    protected function register_controls(): void
    {
        $this->beginContentSection('Contact Details & Email Form');
        ...
        $this->addText('form_title', 'Form heading', 'Share your requirements');
...
final class ContactMapWidget extends AbstractRosaSectionWidget
{
    ...
    public function get_title(): string { return 'Rosa Contact — Location'; }
    protected function register_controls(): void
    {
        $this->beginContentSection('Location');
        $this->addText('map_eyebrow', 'Eyebrow', 'Location');
        $this->addText('map_button', 'Map button label', 'Search on maps');
        $this->end_controls_section();
    }
    protected function render(): void { $this->renderSection('contact-map'); }
}
