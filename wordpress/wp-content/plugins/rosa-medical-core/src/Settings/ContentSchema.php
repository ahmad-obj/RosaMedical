        ...
        return [
            ...
            'home' => [
                ...
                'groups' => [
                    ...
                    'Who We Are' => ['who_eyebrow', 'who_title', 'who_body', 'who_button', 'stat_1_value', 'stat_1_label', 'stat_2_value', 'stat_2_label', 'stat_3_value', 'stat_3_label'],
                    'Featured Products Support' => ['featured_title', 'benefit_1_title', 'benefit_1_body', 'benefit_2_title', 'benefit_2_body', 'benefit_3_title', 'benefit_3_body'],
                    'Feature Banner' => ['feature_eyebrow', 'feature_title', 'feature_body', 'feature_button'],
                    'Latest Products' => ['latest_title'],
                    'Promo Tiles' => ['promo_1_title', 'promo_1_body', 'promo_2_title', 'promo_2_body', 'promo_3_title', 'promo_3_body', 'promo_4_title', 'promo_4_body'],
                    'Why Rosa' => ['why_eyebrow', 'why_title', 'why_1_title', 'why_1_body', 'why_2_title', 'why_2_body', 'why_3_title', 'why_3_body'],
                    'Catalogue Strip' => ['proof_1', 'proof_2', 'proof_3', 'proof_4', 'proof_5', 'proof_6'],
                    'Workflow' => ['evidence_eyebrow', 'evidence_title', 'evidence_body', 'evidence_1_title', 'evidence_1_body', 'evidence_2_title', 'evidence_2_body', 'evidence_3_title', 'evidence_3_body'],
                ],
                'fields' => [
                    ...
                    'benefit_1_body' => self::field('text', 'Identify the right reference', 'حدد المرجع الصحيح'),
                    'benefit_2_title' => self::field('text', 'Quotation route', 'عرض السعر'),
                    'benefit_2_body' => self::field('text', 'Ask about price and supply', 'اسأل عن السعر والتوريد'),
                    'benefit_3_title' => self::field('text', 'Five families', 'خمس فئات'),
                    'benefit_3_body' => self::field('text', 'Browse instrument ranges', 'تصفح عائلات الأدوات'),
