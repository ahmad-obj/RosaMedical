...
$desktopUrl = rosa_preview_reference_hero_url($heroSlide, 'desktop');
$mobileUrl = rosa_preview_reference_hero_url($heroSlide, 'mobile');
?>
<section class="<?php echo esc_attr($classes); ?>" data-preview-page-hero>
    <picture class="rosa-preview-page-hero__media" aria-hidden="true">
        ...
        <img src="<?php echo esc_url($desktopUrl); ?>" alt="" decoding="async">
    </picture>
