...
<footer class="rosa-preview-footer" data-rosa-preview-footer>
    <div class="rosa-preview-rail rosa-preview-footer__grid">
        ...
        <section><h2><?php echo esc_html($locale === 'ar' ? 'المنتجات' : 'Products'); ?></h2><?php foreach (['Knives','Scissors','Punches','Chisels','Cutters'] as $family) : ?><a href="<?php echo esc_url(home_url($shopPath)); ?>"><?php echo esc_html($family); ?></a><?php endforeach; ?></section>
